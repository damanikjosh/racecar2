...
void playMelody(Melody melody) {
  for (int thisNote = 0; thisNote < sizeof(melody.note); thisNote++) {
    int noteDuration = 1000 / melody.duration[thisNote];
    tone(BDPIN_BUZZER, melody.note[thisNote], noteDuration);
