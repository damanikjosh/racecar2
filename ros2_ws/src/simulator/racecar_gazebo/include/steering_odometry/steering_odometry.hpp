...
#include "steering_odometry/rolling_mean_accumulator.hpp"
...
public:
   ...
   * \param right_rear_traction_wheel_vel  Right rear traction wheel velocity [rad/s]
   * \param left_rear_traction_wheel_vel  Left rear traction wheel velocity [rad/s]
   * \param right_front_traction_wheel_vel  Right front traction wheel velocity [rad/s]
   * \param left_front_traction_wheel_vel  Left front traction wheel velocity [rad/s]
   * \param right_steer_pos Right steer wheel position [rad]
   * \param left_steer_pos Left steer wheel position [rad]
   * \param dt      time difference to last call
   * \return true if the odometry is actually updated
  ...
  /**
   * \brief steer position getter
   * \return steer position [rad]
   */
  double get_steer_pos() const { return steer_pos_; }
  ...
  std::tuple<std::vector<double>, std::vector<double>> get_commands_ackermann(
...
private:
  ...
  /**
   * \brief Calculates linear velocity of a robot with quadruple traction axle
   * \param right_rear_traction_wheel_vel  Right rear traction wheel velocity [rad/s]
   * \param left_rear_traction_wheel_vel  Left rear traction wheel velocity [rad/s]
   * \param right_front_traction_wheel_vel  Right front traction wheel velocity [rad/s]
   * \param left_front_traction_wheel_vel  Left front traction wheel velocity [rad/s]
   */
  std::tuple<double, double> get_linear_velocity_and_steer_pos_quadruple_traction_axle(
    const double right_rear_traction_wheel_vel, const double left_rear_traction_wheel_vel,
    const double right_front_traction_wheel_vel, const double left_front_traction_wheel_vel,
  ...
  RollingMeanAccumulator<double> linear_acc_;
